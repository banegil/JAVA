package simulator.ejemplos.jtable;
...
public class JTableExamples extends JFrame {
	...
	private JComboBox<Dish> _priority;
	...
	public void initGUI() {
		...
		_priority = new JComboBox<>(_dishesModel);
		// comboxfor selecting priority
		for (int i = 0; i < 10; i++) {
			_dishesModel.addElement(new Dish("M"));
		}
	...
	public void addEvent() {
		try {
			...
			Integer priority = (Integer) _priority.getSelectedItem();
