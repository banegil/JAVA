...
public class ChangeWeatherDialog extends JDialog{
	...
	private void initGUI(){
		...
		setTitle("Cambiar Clima Carretera");
		JPanel mainPanel = new JPanel();
		mainPanel.setLayout(new BoxLayout(mainPanel, BoxLayout.Y_AXIS));
		setContentPane(mainPanel);

		JLabel helpMsg = new JLabel("Programa un evento para cambiar el clima de una carretera dado un numero de ticks desde este momento");
        ...
        viewsPanel.add(new JLabel("Carretera: "));
		viewsPanel.add(_dishes);
		viewsPanel.add(new JLabel("Clima: "));
	...
	String getDish() {
		return _dishesModel.getSelectedItem().toString();
	}
	
	Weather getDish2() {
		return Weather.tiempo(_dishesModel2.getSelectedItem().toString());
	}
