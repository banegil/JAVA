...
import simulator.model.objects.InterCityRoad;
...
public class NewInterCityRoad extends NewRoadEvent{
	...
	void execute(RoadMap map) throws NegativeNumber {
		...
		map.addRoad(new InterCityRoad(id, map.getJunction(srcJun), map.getJunction(destJunc), maxSpeed, co2Limit, length, weather));
	}
